...
```bash
$ npm install --save react-native-easy-guesture-responder
```

or

```bash
$ yarn add react-native-easy-guesture-responder
```
...
[Pull requests](https://github.com/Luehang/react-native-easy-guesture-responder/pulls) are welcomed.
...
Not sure where to start, or a beginner? Take a look at the [issues page](https://github.com/Luehang/react-native-easy-guesture-responder/issues).
